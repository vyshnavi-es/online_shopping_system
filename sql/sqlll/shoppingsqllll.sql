...
CREATE TABLE `accessories` (
  ...
  `a_brand` varchar(45) NOT NULL,
  `a_name` varchar(45) NOT NULL,
  `a_price` int NOT NULL,
  `a_quantity` int DEFAULT NULL,
...
CREATE TABLE `bottoms` (
  `idbottoms` int NOT NULL AUTO_INCREMENT,
  `bottom_brand` varchar(45) NOT NULL,
  `bottom_name` varchar(45) NOT NULL,
  `bottom_price` int NOT NULL,
  `bottom_photo` blob NOT NULL,
  `s` int DEFAULT NULL,
  `m` int DEFAULT NULL,
  `l` int DEFAULT NULL,
...
CREATE TABLE `cart` (
  ...
  `pro_brand` varchar(100) DEFAULT NULL,
...
CREATE TABLE `dresses` (
  `iddresses` int NOT NULL AUTO_INCREMENT,
  `dresses_brand` varchar(45) NOT NULL,
  `dresses_name` varchar(45) NOT NULL,
  `dresses_price` int NOT NULL,
  `dresses_photo` blob NOT NULL,
  `s` int DEFAULT NULL,
  `m` int DEFAULT NULL,
  `l` int DEFAULT NULL,
  PRIMARY KEY (`iddresses`)
...
CREATE TABLE `orders` (
  ...
  `pro_photo` blob,
  `del_address` varchar(45) DEFAULT NULL,
  `itemTotal` int DEFAULT NULL,
...
--
-- Table structure for table `tops_tunics_and_dresses`
--

DROP TABLE IF EXISTS `tops_tunics_and_dresses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tops_tunics_and_dresses` (
  `idtops_tunics_and_dresses` int NOT NULL AUTO_INCREMENT,
  `top_brand` varchar(45) DEFAULT NULL,
  `top_name` varchar(45) NOT NULL,
  `top_price` int NOT NULL,
  `top_photo` longblob NOT NULL,
  `s` int DEFAULT NULL,
  `m` int DEFAULT NULL,
  `l` int DEFAULT NULL,
  PRIMARY KEY (`idtops_tunics_and_dresses`)
...
-- Dump completed on 2021-01-29 13:50:47
